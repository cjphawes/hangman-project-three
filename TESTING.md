...
| Inputs "**Y**" or "**N**" to the confirmation question | Input "**Y**" or "**N**"                                 | "**Y**" - A goodbye message is displayed. "**N**" - Redirects the user back to the start question.                                                                                                           | ![Confirmation question Y input](/documentation/doc-gifs/confirmation_yes_to_end_game.gif) ![Confirmation question N input](/documentation/doc-gifs/confirmation_no_to_redirect_user.gif) |
